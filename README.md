...
- If you have already ran install all and get errors, you can reset the install by editing `check.json` and setting the values to the corresponding tools number to `false`.
